...
from ml.model.model import Model, get_model
...
def root(request: Request):
    return templates.TemplateResponse("template/index.html",
                                      {"request": request, "haha": "hhi", "serveradd": request.url_for('root')})
