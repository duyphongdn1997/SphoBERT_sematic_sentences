...
from ml.sentence_transformers.utils import import_from_string, batch_to_device, http_get
...
class SentenceTransformer(nn.Sequential):
            ...
            if model_name_or_path.startswith('http://') or model_name_or_path.startswith('https://'):
                ...
                if not os.listdir(model_path):
                    ...
                    try:
                        ...
                        with ZipFile(zip_save_path, 'r') as zipf:
                ...
                if os.path.exists(os.path.join(model_path, 'config.json')):
                    with open(os.path.join(model_path, 'config.json')) as fIn:
                        ...
                        if config['__version__'] > __version__:
                            logging.warning("You try to use a model that was created with version "
    ...
    def encode(
            ...
            convert_to_numpy: bool = True) -> List[ndarray]:
        """
